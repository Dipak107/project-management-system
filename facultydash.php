...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			?>
				...
				<form class="navbar-form navbar-left">
					...
					{
					?>
						<input type="text" value="" class="form-control" placeholder="<?php echo "Welcome  : " .$fname." | Committe Member of :  ".$course_id ?> " style="width:500px">
						<?php } 
						else
						{
							?>
						<input type="text" value="" class="form-control" placeholder="<?php echo "Welcome : " .$fname?> ">
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2020 <a href="#" target="_blank">Developed by Viraj Thakkar & Dilip Rajput</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
